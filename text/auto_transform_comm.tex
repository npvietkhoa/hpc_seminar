...
% Petal detected that, MPI call \texttt{MPI\_Allgather} in line 14 for gathering the new vector \texttt{Blo\_Vector\_X}, which is independent of computing \texttt{Hvector Bloc\_HVector} and its vector dot product with the residue vector. 
